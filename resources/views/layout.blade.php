...
<li class="nav-item">
  <a class="nav-link text-white " href="/pegawai">
      <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
        <i class="fa-solid fa-users text-white text-sm opacity-10"></i>
      </div>
...
<li class="nav-item">
  <a class="nav-link text-white " href="/inventaris">
      <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
...
<li class="nav-item">
  <a class="nav-link text-white " href="/ruang">
      <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
        <i class="ni ni-single-copy-04 text-white text-sm opacity-10"></i>
      </div>
...
<li class="nav-item">
  <a class="nav-link text-white " href="jenis">
      <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
...
<!-- Inventaris -->
 <li class="nav-item mt-3">
  <h6 class="ps-4 ms-2 text-uppercase text-xs text-white font-weight-bolder opacity-8">Peminjaman</h6>
</li>
<li class="nav-item">
  <a class="nav-link text-white " href="/peminjaman">
      <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
        <i class="fa-solid fa-right-from-bracket text-white text-sm opacity-10"></i>
      </div>
